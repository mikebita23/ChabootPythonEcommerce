...
class UserTest(TestCase):
    def test_get_all_users(self):
        ...
        self.assertEqual("Mike", users[0].first_name)
        self.assertEqual("Michel", users[0].last_name)
    ...
    def test_get_current_user(self):
        ...
        self.assertEqual("Mike", user.first_name)
        self.assertEqual("Michel", user.last_name)
