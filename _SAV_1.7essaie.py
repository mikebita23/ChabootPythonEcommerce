...
#######################################################
################ SAV V1.6 by W.SELLIER ################
#######################################################
    #Version v1 Mike&Michel GLS
import re
import os
import sys
import shutil
...
def shopify_request(shop, param, param1, put_data):
    pass
                        ...
                        if shop != None:
                            ...
                            for l in history:
                                if l[0] == message["email"]:
                                    ...
                                    gmail_request("BUFFALO", "post", "drafts", endpoints="",
                                                  post_data={"message": mime_msg})
                                    break
                            if q:
